...
data Term    = Var     Location Name                         -- variables
             ...
             | Enum    Location [Label]                      -- enumerations (finite types)
             | Label   Location Label                        -- labels
             | Case    Location Term [(Label,Term)]          -- case t of { L1 -> u1 | ... | L1 -> un }
